...
(function() {
  ...
  const translations = {
    pt: {
      ...
      salvePiramideSub: 'Jogo educacional para aulas de matemática, desenvolvido com Cocos Creator (JavaScript).',
      showMonstroSub: 'Jogo educacional no estilo quiz, desenvolvido com Cocos Creator (JavaScript).',
      zumbisDesorganizadosSub: 'Jogo educacional para aulas de língua portuguesa. Desenvolvido com Cocos Creator (JavaScript).',
    ...
    en: {
      ...
      salvePiramideSub: 'Educational game for math classes, developed with Cocos Creator (JavaScript).',
      showMonstroSub: 'Educational game, quiz-like. Developed with Cocos Creator (JavaScript).',
      zumbisDesorganizadosSub: 'Educational game for language classes. Developed with Cocos Creator (JavaScript).',
