...
(function() {
  ...
  const translations = {
    ...
    en: {
      ...
      // Unbinary project translations
      unbinaryTitle: 'Unbinary',
      unbinarySub: 'UNBINARY is a hand-painted virtual reality puzzle adventure game. Meet Webby, a super AI created from collected human behavior data and a candidate to govern planet Earth. Is she really ready to fulfill her purpose?',
      unbinaryHeading: 'Participation',
      unbinaryDescription: 'As the lead developer, I was responsible for the entire development and completion of the game after its DEMO version, which initially had 5 levels. Throughout the process, I developed systems and mechanics to support all expected progression and performance requirements. I successfully navigated the entire META Quest store approval process, aligning and enhancing the game to meet the store\'s requirements.\n\nTechnologies used: Unity, C#, PlayMaker, and QUIL.',
